    ...
    <section className="w-full bg-white py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
          <div>
            <p className="text-[10px] font-semibold tracking-widest text-gray-400 uppercase border border-gray-200 rounded-full inline-block px-3 py-1 mb-2">
              Info Kunjungan
            </p>
            <h2 className="text-xl font-black text-gray-900">Lokasi &amp;<br />Jam Buka</h2>
          </div>
